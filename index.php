...
<head>
    ...
    <title>Home - Andaman College Library- Automated and digital way of mantaining libraries</title>
            ...
            <div class="container">
                <div class="row wow fadeInUp">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 text-center">
                        <div class="jumbotron">
                            <h1 class="text-white">Andaman College Library Management System</h1>
